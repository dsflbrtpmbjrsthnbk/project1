        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomIdPattern = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Inventories_Categories_Category",
                        column: x => x.Category,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsInTableView = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InventoryComments_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    RowVersion = table.Column<byte[]>(type: "bytea", rowVersion: true, nullable: false),
                    StringField0 = table.Column<string>(type: "text", nullable: true),
                    StringField1 = table.Column<string>(type: "text", nullable: true),
                    StringField2 = table.Column<string>(type: "text", nullable: true),
                    TextField0 = table.Column<string>(type: "text", nullable: true),
                    TextField1 = table.Column<string>(type: "text", nullable: true),
                    TextField2 = table.Column<string>(type: "text", nullable: true),
                    NumberField0 = table.Column<double>(type: "double precision", nullable: true),
                    NumberField1 = table.Column<double>(type: "double precision", nullable: true),
                    NumberField2 = table.Column<double>(type: "double precision", nullable: true),
                    LinkField0 = table.Column<string>(type: "text", nullable: true),
                    LinkField1 = table.Column<string>(type: "text", nullable: true),
                    LinkField2 = table.Column<string>(type: "text", nullable: true),
                    BoolField0 = table.Column<bool>(type: "boolean", nullable: true),
                    BoolField1 = table.Column<bool>(type: "boolean", nullable: true),
                    BoolField2 = table.Column<bool>(type: "boolean", nullable: true),
                    SearchVector = table.Column<NpgsqlTsVector>(type: "tsvector", nullable: false)
                        .Annotation("Npgsql:TsVectorConfig", "english")
                        .Annotation("Npgsql:TsVectorProperties", new[] { "CustomId", "StringField0", "StringField1", "StringField2", "TextField0", "TextField1", "TextField2" })
                },
                constraints: table =>
                {
